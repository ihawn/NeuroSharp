...
namespace UnitTests
{
    public class MultiChannelConvolutionalLayerTests
    {
        ...
        [Test]
        public void MultiChannelConvLayer_BackPropagation_ReturnsCorrectInputGradient_CategoricalCrossentropy()
        {
        ...
        [Test]
        public void MultiChannelConvLayer_BackPropagation_ComputesCorrectWeightGradient_CategoricalCrossentropy()
        {
            Vector<double> testX = Vector<double>.Build.DenseOfArray(
            new double[]
            {
                ...
                5, 6, 7, 8, 18, 19, 20, 21, 22,      //green
                9, 10, 11, 12, 23, 24, 25, 26, 27,   //blue
                28, 29, 30, 31, 32, 33, 34, 35, 36   //alpha
            });
