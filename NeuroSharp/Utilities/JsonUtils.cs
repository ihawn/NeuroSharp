...
namespace NeuroSharp.Utilities
{
    public class JsonUtils : JsonConverter
    {
            ...
            List<Layer> layers = jo["Layers"].Select(layer => 
                ...
                GetLayerType(layer) == LayerType.MultiChannelConvolutional ?
                    new MultiChannelConvolutionalLayer(
                            ...
                            channelOutputs: JsonToArrayOfVectors(layer["_channelOutputs"], "_channelOutputs"),
                            channelInputs: JsonToArrayOfVectors(layer["_channelInputs"], "_channelInputs"),
                            channelBackpropagationOutputs: JsonToArrayOfVectors(layer["_channelBackpropagationOutputs"], "_channelBackpropagationOutputs"),
        ...
        public Vector<double>[] JsonToArrayOfVectors(JToken obj, string name)
        {
